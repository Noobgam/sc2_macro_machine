...
class CombatCommander
{
    ...
    std::optional<Unit> findClosestDefender(const Squad & defenseSquad, const CCPosition & pos);
    std::optional<Unit> findClosestWorkerTo(std::vector<Unit> & unitsToAssign, const CCPosition & target);
