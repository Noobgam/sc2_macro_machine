#include "AggressiveTechBuildManager.h"

#include "../../general/CCBot.h"

AggressiveTechBuildManager::AggressiveTechBuildManager(CCBot & bot) : BuildManager(bot) { }

// prioritize double gate at the start
std::optional<BuildOrderItem> AggressiveTechBuildManager::getTopPriority() {
    ...
    if (!hasGate) {
        if (m_bot.UnitInfo().getBuildingCount(Players::Self, gatewayType, UnitStatus::TOTAL) > 1) {
            return {};
        }
